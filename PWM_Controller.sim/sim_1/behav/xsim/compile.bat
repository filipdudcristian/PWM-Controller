...
REM
REM Generated by Vivado on Mon Jan 08 13:24:50 +0200 2024
...
echo "xvhdl --incr --relax -prj pwm_led_tb_vhdl.prj"
call xvhdl  --incr --relax -prj pwm_led_tb_vhdl.prj -log xvhdl.log
